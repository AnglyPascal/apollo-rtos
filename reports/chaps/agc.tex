\section{The Apollo Guidance Computer: Historical Context}

\begin{enumerate}
    \item Brief history of the AGC development
    \item Technical specifications and constraints
    \item Key design principles and innovations
    \item Notable features of the original operating system 
\end{enumerate}
...
\subsection{AGC Operating System Architecture}

\begin{enumerate}
    \item Core components and structure
    \item Memory management approach
    \item Executive system and task scheduler
    \item Interrupt handling system
    \item I/O subsystem 
\end{enumerate}
